        ...
        <div className="max-w-4xl mx-auto  pl-8">
          <div className="flex items-center justify-between py-1">
            ...
            <div className="pt-2   relative group flex items-center justify-center gap-4 cursor-pointer mx-7 md:mx-0">
              ...
              <div className=" ">
                <button className="text-xl bg-blue-600 group text-white p-2 rounded-full group-hover:text-emerald-700 group-hover:bg-emerald-200 transition-colors duration-300 shadow-[0_3px_10px_rgb(0,0,0,0.2)] cursor-pointer">
                  <FaUser />
                </button>
