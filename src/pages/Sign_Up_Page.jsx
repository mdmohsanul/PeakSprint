  ...
  return (
    <>
      <section className="w-full md:pl-64 bg-gray-50 dark:bg-gray-900">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto pt-10 lg:py-0">
          <div className="w-full bg-white rounded-lg shadow-[1px_1px_20px_10px_#00000024] dark:border md:mt-10 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
